...
public interface EurekaInstanceConfig {
     ...
     *
     * 将此值设置得太长可能意味着即使实例不活动，流量也可以路由到实例。
     * 将此值设置得太小可能意味着，由于临时网络故障，实例可能会被取消流量。
     * 此值设置为至少高于{@link #getLeaseRenewalIntervalInSeconds（）}中指定的值
     *
     * 租约过期时间，单位：秒
     ...
     * this instance.
     * </p>
     * 这通常是其他实例通过使用虚拟主机名来查找此实例的方式。
     * 此提示与完全限定的域名类似，您的服务用户需要查找此实例。
     *
     * 虚拟主机名。
     * 也可以叫做 VIPAddress 。
